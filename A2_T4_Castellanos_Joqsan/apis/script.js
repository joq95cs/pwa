...
$(document).ready(function() {
    ...
    class CRUD {
        ...
        registrar() {
            ...
            let url = "http://localhost/curso_php/practicas/api_peliculas/api_rest.php?opcion=1&id=" + id + "&nombre=" + nombre + "&director=" + director + "&estudio=" + estudio + "&agno=" + agno + "&pais=" + pais + "&genero=" + genero;
        ...
        buscar() {
            ...
            let url = "http://localhost/curso_php/practicas/api_peliculas/api_rest.php?opcion=2&id=" + id;
        ...
        actualizar() {
            ...
            let url = "http://localhost/curso_php/practicas/api_peliculas/api_rest.php?opcion=3&id=" + id + "&nombre=" + nombre + "&director=" + director + "&estudio=" + estudio + "&agno=" + agno + "&pais=" + pais + "&genero=" + genero;
        ...
        eliminar() {
            ...
            let url = "http://localhost/curso_php/practicas/api_peliculas/api_rest.php?opcion=4&id=" + id;
